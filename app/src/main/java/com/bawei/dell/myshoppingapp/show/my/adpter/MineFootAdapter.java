...
public class MineFootAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<FootmarkBean.ResultBean> mList;
    ...
    public void setList(List<FootmarkBean.ResultBean> datas) {
        mList.clear();
        if (datas!=null){
            mList.addAll(datas);
        }
    ...
    public void addList(List<FootmarkBean.ResultBean> datas) {
        if (datas!=null){
            mList.addAll(datas);
        }
        notifyDataSetChanged();
    ...
    public XRecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(mContext).inflate(R.layout.footmark_item,
                viewGroup,false);
